export default function GrupoCertificadoCard({ grupo, total, onClick }) {
  return (
    <button onClick={onClick} className="card-interactive group flex w-full flex-col items-start gap-3 p-6 text-left">
      ...
      <span className="link-underline mt-2 text-sm text-text-primary">Ver certificados →</span>
    </button>
  )
}
